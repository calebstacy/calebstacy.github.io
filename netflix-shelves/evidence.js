...
function App() {
  ...
  return /*#__PURE__*/React.createElement(Report, {
    ...
    subtitle: fmtN(countKind("shelf-heading")) + " shelf headings, " + fmtN(countKind("genre-name")) + " genre names, " + fmtN(countKind("list-name")) + " list names, and " + fmtN(countKind("ui-label")) + " interface labels, and patterns observed in the public corpus.",
  ...
  }, "A record does two jobs from the same boundary. Adopted, it gates: a draft that breaks Title Case or spells out the connective returns for review before a person reads it. The same boundary is a hypothesis: ship “and” to half a shelf's viewers, and the connective record stops being taste and becomes a readout. ", /*#__PURE__*/React.createElement("a", {
    href: "../netflix/index.html#move-3"
  }, "The walkthrough derives voice records the same way.")), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 1em"
    }
  }, "Those records can answer lane-specific questions and hold a draft name to the same rules. ", /*#__PURE__*/React.createElement("a", {
    href: "./"
  }, "The recorded proof"), " shows that loop on one exact string.")), /*#__PURE__*/React.createElement(ReportSection, {
    id: "content-index",
